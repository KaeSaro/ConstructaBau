              ...
              <div className="flex justify-center w-full space-x-6 lg:space-x-12">
                {menuItems.map((item) => (
                  ...
                  >
                    {item.name}
                    <span
                      className={`absolute bottom-0 left-0 h-0.5 bg-[#0d0e14] transition-all duration-300 ease-in-out
              ...
              >
                <div className="relative w-7 h-2.5 ml-auto">
                  <span
                    ...
                    ${isOpen ? 'top-1 rotate-45 bg-white' : 'top-0 bg-[#0d0e14]'}
                  `}
                  />
                  <span
                    className={`
                    absolute left-0 w-full h-[2px] transform transition-all duration-300 ease-in-out
                    ${isOpen ? 'top-1 -rotate-45 bg-white' : 'top-2.5 bg-[#0d0e14]'}
                  `}
                  />
                </div>
              </button>
