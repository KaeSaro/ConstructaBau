    ...
    <div className="flex flex-col mt-[640px] space-y-20">
      ...
      <section className="[&>h1]:!text-[24px] md:[&>h1]:!text-[40px] lg:[&>h1]:!text-[50px] space-y-4">
        ...
        <div className="[&>p]:!text-[16px] md:[&>p]:!text-[20px] lg:[&>p]:!text-[24px] space-y-1">
          ...
          <RegularText>
            Rechtsgrundlage für die Verarbeitung ist Art. 6 Abs. 1 lit. b DSGVO, da die Verarbeitung für die Bearbeitung
          ...
          <RegularText>
            ...
            sind. Dies ist der Fall, wenn die jeweilige Konversation beendet ist und keine gesetzlichen
      ...
      <section className="[&>h1]:!text-[24px] md:[&>h1]:!text-[40px] lg:[&>h1]:!text-[50px] space-y-4">
        ...
        <div className="[&>p]:!text-[16px] md:[&>p]:!text-[20px] lg:[&>p]:!text-[24px] space-y-1">
          ...
          <RegularText>
            Die Nutzung von Google Fonts erfolgt im Interesse einer einheitlichen und ansprechenden Darstellung unserer
